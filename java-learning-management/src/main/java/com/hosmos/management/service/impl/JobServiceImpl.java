...
import com.hosmos.management.dao.JobDao;
import com.hosmos.management.job.SpringBeanJob;
...
public class JobServiceImpl implements JobService {
    ...
    public void saveJob(JobModel jobModel) {
        ...
        JobDetail jobDetail = JobBuilder.newJob(SpringBeanJob.class).storeDurably().withDescription(jobModel.getDescription()).withIdentity(jobKey).build();
    ...
    public JobModel getByName(String jobName) {
        return jobDao.getByName(jobName);
    }
    ...
    public int count(Map<String, Object> params) {
        return jobDao.count(params);
    }

    @Override
    public List<JobModel> list(Map<String, Object> params, Integer offset, Integer limit) {
        return jobDao.list(params, offset, limit);
    }
}