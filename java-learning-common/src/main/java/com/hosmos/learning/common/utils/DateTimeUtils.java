   ...
   */
   public static final String DEFAULT_TIME_HHmm_FORMAT_PATTERN = "HH:mm";
    ...
    public static String getCurrentDate() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateTimeUtils.DATE_FORMAT);
    ...
    public static String getCurrentDateTime() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateTimeUtils.DATE_TIME_FORMAT);
        datestr = df.format(new Date());
        return datestr;
    }
    ...
    public static Date stringToDate(String datestr) {
        ...
        try {
            ...
            date=DateTimeUtils.stringToDate(datestr,"yyyyMMdd");
        }
        return date;
    }
    ...
    public static Date getLastDayOfMonth(Date date) {
        return DateTimeUtils.addDay(DateTimeUtils.getFirstDayOfMonth(DateTimeUtils.addMonth(date, 1)), -1);
    }
    ...
    public static long getDayByMinusDate(Object fromDate, Object toDate) {
        ...
        Date f=DateTimeUtils.chgObject(fromDate);

        Date t=DateTimeUtils.chgObject(toDate);
    ...
    public static int calcAge(Date birthday, Date calcDate) {
        ...
        int cYear=DateTimeUtils.getYearOfDate(calcDate);
        int cMonth=DateTimeUtils.getMonthOfDate(calcDate);
        int cDay=DateTimeUtils.getDayOfDate(calcDate);
        int bYear=DateTimeUtils.getYearOfDate(birthday);
        int bMonth=DateTimeUtils.getMonthOfDate(birthday);
        int bDay=DateTimeUtils.getDayOfDate(birthday);
    ...
    public static String getBirthDayFromIDCard(String idno) {
        ...
        return DateTimeUtils.dateToString(cd.getTime());
    }
    ...
    public static Date chgObject(Object date){
        ...
        if(date!=null&&date instanceof String){
            return DateTimeUtils.stringToDate((String)date);
        }
